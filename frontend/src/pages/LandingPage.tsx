...
const steps = [
  {
    ...
    description: 'Organizers set up an event and share a link. Attendees join with one click.',
  },
  {
    number: 2,
    title: 'Photos get added',
    description: 'Organizers upload all photos from the event into one shared album.',
  },
  {
    number: 3,
    title: 'Upload a photo of yourself',
    description: "We scan the album and pull out every photo you appear in. That's it.",
  },
];
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          ...
          <nav className="flex items-center gap-3">
            <button
              ...
              className="rounded-full cursor-pointer border border-white/25 px-5 py-2 text-sm font-medium transition-colors hover:bg-white/10"
            >
              Log in
            </button>
            <button
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <h1 className="text-4xl font-bold leading-tight sm:text-5xl">
              Your photos from any event, <span className="text-[#E2632F]">found instantly.</span>
            </h1>

            <p className="mt-6 max-w-md text-lg text-white/60">
              Upload a photo of yourself. We'll find every picture you're in — from any event album
              — in seconds.
            </p>
            ...
            <div className="mt-8 flex items-center gap-4">
              <button
                onClick={() => navigate('/signup')}
                className="rounded-lg border border-white/25 cursor-pointer px-6 py-3 font-semibold transition-colors hover:bg-white/10"
              >
                Get started
              </button>
              <button
                onClick={() => navigate('/login')}
                className="rounded-lg border border-white/25 px-6 py-3 cursor-pointer font-semibold transition-colors hover:bg-white/10"
              >
                Log in
              </button>
            </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 text-sm text-white/60">Green = your photos</p>
          </div>
        </div>
      </section>
